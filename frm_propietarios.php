...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/frm_propietarios.css">
    </head>
    ...
    <body>
        <div>
            <div class="card" id="sesion">
                ...
                <div class="card-footer"><a href="cerrar.php" class="cerrarsesion">
                        ...
                        Cerrar Sesión</a>&nbsp; &nbsp; <a href="dashboard.php" class="cerrarsesion"><img src="img/icons/VolverAtras.png" width="18px"> Volver Atras</a></div>
            </div>
        </div>
        <br> 
        <br>
        <div class="menu frm">
            <div class="card">
                <div class="card-header text-center">
                    <h4>Administrador de Propietarios</h4>
                </div>
                <div class="card-body col-auto">
                    <form action="crud_propietarios.php" method="post" name="frm_usu">
        ...
        <div class="menu tamaño">
            <div class="card">
                <div class="card-header" style="text-align: center;">
                    <h5>Listados de Propietarios</h5>
                </div>
                <div class="card-body">
                            ...
                            ?>
                                <tr class="textaling">
                                    ...
                                    <td>
                                        ...
                                        {
                                            ?>
                                        <a href="frm_propietarios.php?id=<?php echo $datos['id']; ?>"><img src="img/icons/reload.png" alt="" width="25px"></a> &nbsp; &nbsp; <?php if ($datos['estado'] == 1) { ?>| &nbsp; &nbsp;

                                        <!-- Mandamos datos por href -->
                                        <a href="crud_propietarios.php?id=<?php echo $datos['id'];?>&estado=<?php echo $datos['estado'];?>">
        ...
        <div class="card-footer"><h4> Total de Usuarios (<?php echo $con; ?>)</h4> <hr> <a class="cerrarsesion" href="exportarExcel.php"><h4> Exportar a Excel <img src="img/icons/excel_888900 (1).png" alt="" width="25px"></h4></a></div>
        </div>
        </div>
